...
public class PolarBearFishGoal extends MoveToTargetPosGoal {
    private int upTick;
    private boolean fished = false;
    private int stayTick;
    public PolarBearFishGoal(PolarBearEntity mob, double speed, int range) {
    ...
    protected boolean isTargetPos(WorldView world, BlockPos pos) {
        return ((world.getBlockState(pos).isOf(Blocks.ICE)) && world.isAir(pos.up()));
    }
